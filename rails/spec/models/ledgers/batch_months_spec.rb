...
RSpec.describe BatchMonths, :ledgers do
  describe 'make month as id' do
    it 'can return now' do
      batch_months = described_class.make month: BatchMonths::MAR
  ...
  describe '#period' do
    ...
    it 'calculates Sep period' do
      batch_months = described_class.make month: BatchMonths::SEP
    ...
    it 'calculates Jun period' do
      batch_months = described_class.make month: BatchMonths::JUN
    ...
    it 'calculates Dec period' do
      batch_months = described_class.make month: BatchMonths::DEC
